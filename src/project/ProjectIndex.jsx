          ...
          <Grid item md={3} sm={6} xs={12}>
            <Card sx={{ width:'100%',height:"100%",display:'flex',flexDirection:'column',justifyContent:"start",gap:'10px'  }}>
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="text.secondary">
                  Here i created online snake game.
                </Typography>
              </CardContent>
              <CardActions sx={{flexGrow:'1',alignContent:'end',alignItems:'end'}}>
                <Button size="small" variant='contained' onClick={handleProject7} >Open</Button>
              </CardActions>
            </Card>
          </Grid>
          <Grid item md={3} sm={6} xs={12}>
            <Card sx={{ width:'100%',height:"100%",display:'flex',flexDirection:'column',justifyContent:"start",gap:'10px'  }}>
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="text.secondary">
                  Here i created online Tic Toc Toe game.
                </Typography>
              </CardContent>
              <CardActions sx={{flexGrow:'1',alignContent:'end',alignItems:'end'}}>
                <Button size="small" variant='contained' onClick={handleProject8} >Open</Button>
              </CardActions>
            </Card>
          </Grid>
        </Grid>
